...
fft_features_std = fft_extraction(d1234_pen_win); % output: 60 obs x16 features double
fft_features_pen = fft_extraction(d1234_steady_win); % output: 60 obs x16 features double
fft_features_all = vertcat(fft_features_std,fft_features_pen); % output: 120 obs x16 features double
