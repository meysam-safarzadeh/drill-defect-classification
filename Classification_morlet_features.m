%% CLASSIFICATION OF DATA MORLET FEATURES
...
morlet_features_std = morlet_extraction(d1234_pen_win); % output: 60 obs x16 features double
morlet_features_pen = morlet_extraction(d1234_steady_win); % output: 60 obs x16 features double
morlet_features_all = vertcat(morlet_features_std,morlet_features_pen); % output: 120 obs x16 features double
